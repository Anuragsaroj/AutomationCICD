package anuragsaroj.TestComponenets;
...
public class BaseTest {
	...
	public WebDriver initialDriver() throws IOException {
		...
		FileInputStream file = new FileInputStream(
				System.getProperty("user.dir") + "\\src\\main\\java\\anuragsaroj\\resource\\GlobalData.properties");
		prop.load(file);

		String BroserName = System.getProperty("browser") != null ? System.getProperty("browser")
